...
struct HelpView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("FileOrganiser Help")
...
private struct GettingStartedContent: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            Text("Welcome to FileOrganiser! This app uses AI to intelligently sort your files into logical folders.")
                .font(.body)
...
private struct OrganizingContent: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            Section {
                Text("FileOrganiser uses AI to understand your files and create a logical folder structure. Here's how the process works:")
...
private struct ShortcutsContent: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            Text("Master FileOrganiser with these keyboard shortcuts.")
        ...
        VStack(alignment: .leading, spacing: 20) {
            ...
            TroubleshootItem(
                ...
                solutions: [
                    ...
                    "Try running FileOrganiser with elevated permissions (right-click → Open)"
                ]
            )
