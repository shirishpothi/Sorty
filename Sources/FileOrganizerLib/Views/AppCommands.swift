...
public struct FileOrganizerCommands: Commands {
    ...
    public var body: some Commands {
        ...
        CommandGroup(replacing: .help) {
            ...
            Link("GitHub Repository", destination: URL(string: "https://github.com/shirishpothi/FileOrganizer")!)
...
public class AppState: ObservableObject {
    ...
    private func generateHTML(from plan: OrganizationPlan) -> String {
        ...
        <head>
            <meta charset="UTF-8">
            <title>FileOrganiser Export</title>
            <style>
    ...
    public func showHelp(initialSection: HelpSection = .gettingStarted) {
        ...
        window.title = "FileOrganiser Help"
        window.center()
