...
- **Nutrition Labels require complete flow coverage.** Claiming "VoiceOver supported" means *every* user flow works — login, onboarding, checkout, settings — not just the main screen.
